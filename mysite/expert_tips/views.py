...
from expert_tips.serializers import ExpertTipModelSerializer, ExpertTipBasicDetailSerializer
...
#event detail based on event slug
class ExpertTipDetail(APIView):
    ...
    def get(self, request, slug, format=None):
        ...
        next_tip_serializer = ExpertTipBasicDetailSerializer(next_tip)

        prev_tip = ExpertTip.objects.prev_tip(tip.id)
        prev_tip_serializer = ExpertTipBasicDetailSerializer(prev_tip)
