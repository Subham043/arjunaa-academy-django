...
class Enquiry(TimestampInfo): #extends timestamp info abstract class
    ...
    course = models.ForeignKey(Course, on_delete=models.SET_NULL, null=True, related_name="enquiries_recieved") #using the user model here for author forign key
    ...
    uploaded_by = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True, related_name="enquiries_uploaded") #using the user model here for author forign key
